...
import { concatMap, tap, toArray, catchError } from 'rxjs';
import { readLinesObs } from 'observable-fs';
import { checkoutRepoAtBranch$ } from '../git-functions/repo';
import { currentBranchName$ } from '../git-functions/branches';
    ...
    It starts with the cloc header`, (done) => {
        ...
        currentBranchName$(repoFolder).pipe(
            concatMap((branchName) => {
                ...
                return clocByFileForRepos$(repoFolder)
            }),
            toArray(),
            tap({
                next: (clocInfos) => {

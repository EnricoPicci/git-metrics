...
describe(`filterCSV$`, () => {
    it(`filters ther records that contain certain substrings in their "file" field`, (done) => {
    ...
    it(`filters ther records using the noneOfStringsPresent function`, (done) => {
        const csvFileName = 'a-cloc-diff-between-dates.csv'
        const csvFilePath = path.join(process.cwd(), 'test-data', 'csv', csvFileName);
...
describe(`filterOutFilesWithKeywords$`, () => {
    it(`filters ther records which have certain keywords in their file names`, (done) => {
        const csvFileName = 'a-cloc-diff-between-dates.csv'
        const csvFilePath = path.join(process.cwd(), 'test-data', 'csv', csvFileName);

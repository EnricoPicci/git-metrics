...
export function launchFetchRepos() {
    ...
    fetchAllRepos$(folderPath, 1, excludeRepoPaths).subscribe()
}
...
function readParams() {
    ...
    program
        ...
        .option(
            ...
            `a space separated list of folder names to be excluded from the fetch action (e.g. --excludeRepoPaths "dbm" "dbobjects") -

...
export function fileAuthorsDictionary(fileCommits: Observable<FileGitCommitEnriched>, after = new Date(0)) {
    return fileCommits.pipe(
        ...
        reduce((fileDict, fileCommit) => {
            ...
            fileAuthorDict[fileCommit.authorName].linesAdded =
                fileAuthorDict[fileCommit.authorName].linesAdded + (fileCommit.linesAdded || 0);
            fileAuthorDict[fileCommit.authorName].linesDeleted =
                fileAuthorDict[fileCommit.authorName].linesDeleted + (fileCommit.linesDeleted || 0);
            fileAuthorDict[fileCommit.authorName].linesAddDel =
                fileAuthorDict[fileCommit.authorName].linesAddDel + (fileCommit.linesAdded || 0) + (fileCommit.linesDeleted || 0);

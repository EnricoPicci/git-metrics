...
export function mongoAuthorChurnReport(
    ...
    return _mongoAuthorChurnReport(params, csvFilePath).pipe(
        tap((report) => addProjectInfo(report, projectInfo, csvFilePath)),
        map((report) => report as MongoAuthorChurnReport),
...
export function _mongoAuthorChurnReport(params: MongoAuthorChurnReportParams, csvFilePath = '') {

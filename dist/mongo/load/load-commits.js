...
function loadCommits(commitLogPath, connectionString, dbName, commitsCollection, bufferSize = 1, clocLogPath, logProgress = false, mongoConcurrency = 1) {
    ...
    const bufferedCommits = clocLogPath
        ? (0, read_cloc_log_1.clocFileDict)(clocLogPath).pipe((0, operators_1.concatMap)((clocDict) => (0, commits_1.gitCommitStream)(commitLogPath, clocDict)), (0, operators_1.bufferCount)(bufferSize), (0, operators_1.tap)(logProgressTap))

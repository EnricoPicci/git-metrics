...
describe(`projectInfo`, () => {
    it(`calculates the general project info`, (done) => {
        ...
        (0, rxjs_1.concatMap)(({ commitsCollection }) => {
            ...
            (0, chai_1.expect)(prjInfo.commits.first.authorDate.getFullYear()).equal(2019);
            (0, chai_1.expect)(prjInfo.commits.last.authorDate.getFullYear()).equal(2021);
...
//# sourceMappingURL=mongo-add-prj-info.spec.js.map
...
function mongoFileChurnReport(params, projectInfo, csvFilePath) {
    ...
    }), (0, operators_1.map)((report) => report), (0, operators_1.map)((report) => (0, mongo_report_1.cleanParamsForReport)(report)), (0, operators_1.map)((report) => (0, file_churn_report_1.addConsiderationsForFileChurnReport)(report)));
}

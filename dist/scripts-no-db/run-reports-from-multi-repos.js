...
exports.launchAllReportsFromMultiRepos = void 0;
const commander_1 = require("commander");
const read_git_1 = require("../git-read-enrich/read-git");
const run_reports_from_multi_repos_core_1 = require("./internals/run-reports-from-multi-repos-core");
function launchAllReportsFromMultiRepos() {
    ...
    (0, run_reports_from_multi_repos_core_1.runAllReportsFromMultiRepos)(_repoFolderPath, _options.filter, _options.after, _options.outDir, _options.outFile, _options.clocDefsFile, _depthInFilesCoupling, _options.parallelReadOfCommits, _options.noRenames).subscribe({
        next: (reports) => {
...
exports.launchAllReportsFromMultiRepos = launchAllReportsFromMultiRepos;
//# sourceMappingURL=run-reports-from-multi-repos.js.map
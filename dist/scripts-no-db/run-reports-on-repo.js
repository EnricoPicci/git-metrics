...
If more than one filter has to be specified, make sure they are separated by a space like this -f '*.c' '*.sh')`)
    ...
    (0, run_reports_on_repo_core_1.runReports)(_reports, _repoFolderPath, _options.filter, _options.after, _options.before, _options.outDir, _options.outFilePrefix, _options.clocDefsFile, _options.parallelReadOfCommits, _options.noRenames, _depthInFilesCoupling).subscribe({
        next: (reports) => {
...
exports.launchReports = launchReports;

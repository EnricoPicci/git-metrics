...
exports.launchAllSingleRepoReports = void 0;
const commander_1 = require("commander");
const read_git_1 = require("../git-read-enrich/read-git");
const run_all_single_repo_reports_core_1 = require("./internals/run-all-single-repo-reports-core");
function launchAllSingleRepoReports() {
    ...
    (0, run_all_single_repo_reports_core_1.runAllSingleRepoReports)(_repoFolderPath, _options.filter, _options.after, _options.outDir, _options.outFilePrefix, _options.clocDefsFile, _depthInFilesCoupling, _options.parallelReadOfCommits, _options.noRenames).subscribe({
        next: (reports) => {
...
exports.launchAllSingleRepoReports = launchAllSingleRepoReports;
//# sourceMappingURL=run-all-single-repo-reports.js.map
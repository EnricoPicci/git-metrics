...
quotes and have to be separated by spaces like this --reports 'FileChurnReport' 'ModuleChurnReport'`)
    ...
    _repoFolderPaths
        .pipe((0, operators_1.concatMap)((folders) => (0, run_reports_on_multi_repos_core_1.runAllReportsOnMultiRepos)(_reports, folders, _options.filter, _options.after, _options.before, _options.outDir, _options.outFilePrefix, _options.clocDefsFile, _depthInFilesCoupling, _options.parallelReadOfCommits, _options.noRenames)))
        .subscribe({

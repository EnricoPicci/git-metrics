...
quotes and have to be separated by spaces like this --reports 'FileChurnReport' 'ModuleChurnReport'`)
    ...
    (0, run_reports_on_merged_repos_core_1.runAllReportsOnMergedRepos)(_reports, _repoFolderPath, _options.filter, _options.after, _options.before, _options.outDir, _options.outFilePrefix, _options.clocDefsFile, _depthInFilesCoupling, _options.parallelReadOfCommits, _options.noRenames).subscribe({
        next: (reports) => {

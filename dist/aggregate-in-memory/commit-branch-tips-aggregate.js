...
const commits_and_branch_tips_1 = require("../git-read-enrich/commits-and-branch-tips");
const date_functions_1 = require("../tools/dates/date-functions");
function commitWithBranchTipsPerDayDictionary() {
    return (0, rxjs_1.pipe)((0, commits_and_branch_tips_1.addBranchTips)(), (0, rxjs_1.reduce)((dictStruct, commit) => {
...
function commitDaylySummary() {
    let previousDaylySummary;
    return (0, rxjs_1.pipe)(commitWithBranchTipsPerDayDictionary(), (0, rxjs_1.map)(({ dictionary, lastCommit }) => {
        ...
        Object.entries(dictionary)
            ...
            const daylySummary = commits.reduce((summary, commit) => {
                ...
                const { _lAdd, _lDel } = commit.files.reduce(({ _lAdd, _lDel }, file) => {
                    _lAdd = _lAdd + file.linesAdded;
                    _lDel = _lDel + file.linesDeleted;
                    return { _lAdd, _lDel };
                }, { _lAdd: 0, _lDel: 0 });

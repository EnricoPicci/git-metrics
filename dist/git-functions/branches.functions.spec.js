...
const branches_functions_1 = require("./branches.functions");
describe(`readBranchesGraph`, () => {
    it(`builds the git log command to read the graph of the branches`, () => {
        ...
        const [cmd, out] = (0, branches_functions_1.readBranchesGraphCommand)(config);
...
describe(`readBranchesGraph`, () => {
    it(`read the graphs log from a git repo using git log command and saves them in a file`, (done) => {
        ...
        const returnedOutFilePath = (0, branches_functions_1.readBranchesGraph)(config);
...
//# sourceMappingURL=branches.functions.spec.js.map
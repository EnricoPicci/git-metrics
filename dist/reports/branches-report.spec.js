...
describe(`projectAndBranchesReport`, () => {
    it(`generates the report about the branches as well as the general project info`, (done) => {
        ...
        const daylySummaryDictionary = commits.pipe((0, commit_branch_tips_aggregate_1.commitDaylySummary)());
    ...
    it(`generates the report about the branches using a this repo as a real repo`, (done) => {
        ...
        // aggregation
        const daylySummaryDictionary = _commitStream.pipe((0, commit_branch_tips_aggregate_1.commitDaylySummary)());

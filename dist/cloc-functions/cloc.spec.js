...
describe(`clocByFileForRepos$`, () => {
    ...
    It starts with the cloc header`, (done) => {
        ...
        (0, branches_1.currentBranchName$)(repoFolder).pipe((0, rxjs_1.concatMap)((branchName) => {
            currentBranchName = branchName;
            return (0, cloc_1.clocByFileForRepos$)(repoFolder);
            ...
            return (0, repo_1.checkoutRepoAtBranch$)(repoFolder, 'main');
        }), (0, rxjs_1.catchError)((err) => {
            return (0, repo_1.checkoutRepoAtBranch$)(repoFolder, currentBranchName).pipe((0, rxjs_1.tap)(() => {
                done(err);
            }));
        })).subscribe({
            complete: () => done(),
...
describe(`writeClocByFileForRepos$`, () => {
    it(`notifies the name of the file where the cloc info for the repos in the folder have been written`, (done) => {
        ...
        (0, branches_1.currentBranchName$)(repoFolder).pipe((0, rxjs_1.concatMap)((branchName) => {
            currentBranchName = branchName;
            return (0, cloc_1.writeClocByFileForRepos$)(repoFolder, new Date(), outDir);
        }), (0, rxjs_1.tap)({
            next: ({ outFilePath }) => {

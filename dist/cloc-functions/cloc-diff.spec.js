...
const cloc_diff_1 = require("./cloc-diff");
...
describe('clocDiff$', () => {
    ...
    compared with the second commit of this project`, (done) => {
        ...
        const languages = ['JavaScript', 'TypeScript'];
        let count = 0;
        (0, cloc_diff_1.clocDiff$)(mostRecentCommit, leastRecentCommit, folderPath, languages).subscribe({
            next: (clocDiffStats) => {
                count++;
...
//# sourceMappingURL=cloc-diff.spec.js.map
...
const load_commits_files_1 = require("../mongo/load/load-commits-files");
const load_multi_commits_files_1 = require("../mongo/load/load-multi-commits-files");
const files_query_1 = require("../mongo/query/files-query");
const dictionary_utils_1 = require("../reports/dictionary-utils/dictionary-utils");
...
describe(`timeWindowedFileCommitsDict`, () => {
    ...
    Since in the test data there are 3 commits with distance of one year, then there are 3 time windows`, (done) => {
        ...
        filesObs
            .pipe((0, repo_coupling_report_1.timeWindowedFileCommitsDict)(1, 1), (0, operators_1.tap)({
            next: (timeWindowDict) => {
                // TEST timeWindowDict
    ...
    it(`if the timeWindowLengthInDays is very big, all commits fall into the same timewindow`, (done) => {
        ...
        const filesObs = oneStream(...params);
        filesObs
            .pipe((0, repo_coupling_report_1.timeWindowedFileCommitsDict)(timeWindowLengthInDays, 1), (0, operators_1.tap)({
            next: (timeWindowDict) => {
                // TEST timeWindowDict
...
describe(`splitCommittsInTimeWindows & selectTimeWindowsPresentInAllRepos`, () => {
    ...
    repos are the same, all time windows are present in one repo are also present in the other one and therfore we select all of them`, (done) => {
        ...
        twoFileStreams
            .pipe((0, repo_coupling_report_1.splitCommitsInTimeWindows)(timeWindowLengthInDays), (0, repo_coupling_report_1.selectTimeWindowsPresentInAllRepos)(), (0, operators_1.tap)({
            next: (timeWindows) => {
...
describe(`calculateFileTuplesPerTimeWindow`, () => {
    ...
    in one repo are necessarly present in the other one as well`, (done) => {
        ...
        twoStreamsFromSameRepo(...params)
            .pipe((0, repo_coupling_report_1.splitCommitsInTimeWindows)(timeWindowLengthInDays), (0, repo_coupling_report_1.selectTimeWindowsPresentInAllRepos)(), (0, repo_coupling_report_1.calculateFileTuplesPerTimeWindow)(), (0, operators_1.tap)({
...
describe(`aggregateFileTuples`, () => {
    ...
    the result so is a 3 * 3 = 9 combinantions`, (done) => {
        ...
        const timeWindowLengthInDays = 1;
        twoStreamsFromSameRepo(...params)
            .pipe((0, repo_coupling_report_1.splitCommitsInTimeWindows)(timeWindowLengthInDays), (0, repo_coupling_report_1.selectTimeWindowsPresentInAllRepos)(), (0, repo_coupling_report_1.calculateFileTuplesPerTimeWindow)(), (0, repo_coupling_report_1.groupFileTuples)(), (0, operators_1.tap)({
            next: (fileTuples) => {
...
describe(`flatFilesCsv`, () => {
    it(`generate an array of strings, each representing one file in a specific tuple, in csv format`, (done) => {
        ...
        const timeWindowLengthInDays = 1;
        twoStreamsFromSameRepo(...params)
            .pipe((0, repo_coupling_report_1.splitCommitsInTimeWindows)(timeWindowLengthInDays), (0, repo_coupling_report_1.selectTimeWindowsPresentInAllRepos)(), (0, repo_coupling_report_1.calculateFileTuplesPerTimeWindow)(), (0, repo_coupling_report_1.groupFileTuples)(), (0, repo_coupling_report_1.flatFilesCsv)(), (0, operators_1.toArray)(), (0, operators_1.tap)({
            next: (fileTuplesCsv) => {
...
//# sourceMappingURL=repo-coupling-report.mongo.spec-long.js.map
...
exports.launchClocDiffByfileWithCommitForRepos = void 0;
const commander_1 = require("commander");
const cloc_diff_commit_1 = require("../../git-cloc-functions/cloc-diff-commit");
function launchClocDiffByfileWithCommitForRepos() {
    ...
    (0, cloc_diff_commit_1.writeClocDiffWithCommitForRepos$)(folderPath, outdir, from, to, excludeRepoPaths, languages).subscribe({
        complete: () => {
            console.log(`\nCloc Diff Byfile with Commit For Repo calculation completed in ${(Date.now() - start) / 1000} seconds`);
        },
    });
}
exports.launchClocDiffByfileWithCommitForRepos = launchClocDiffByfileWithCommitForRepos;
function readParams() {
...
//# sourceMappingURL=launch-cloc-diff-byfile-with-commit-for-repos.js.map
        ...
        const repos = [
            {
                ...
                commitsByMonth: {
                    '2021-01': {
                        commits: [
                            { sha: '123', author: 'author1', date: new Date('2021-01-01'), subject: 'comment', repo: 'repo' },
                            { sha: '456', author: 'author2', date: new Date('2021-01-15'), subject: 'comment', repo: 'repo' },
                        ],
                        authors: new Set(['author1', 'author2']),
                    },
                    '2021-02': {
                        commits: [
                            { sha: '789', author: 'author3', date: new Date('2021-02-01'), subject: 'comment', repo: 'repo' },
                            { sha: 'abc', author: 'author1', date: new Date('2021-02-15'), subject: 'comment', repo: 'repo' },
                        ],
            ...
            },
            {
                ...
                commitsByMonth: {
                    '2021-01': {
                        commits: [
                            { sha: 'def', author: 'author5', date: new Date('2021-01-01'), subject: 'comment', repo: 'repo' },
                            { sha: 'ghi', author: 'author4', date: new Date('2021-01-15'), subject: 'comment', repo: 'repo' },
                        ],
                        authors: new Set(['author4', 'author5']),
                    },
                    '2021-02': {
                        commits: [
                            { sha: 'jkl', author: 'author4', date: new Date('2021-02-01'), subject: 'comment', repo: 'repo' },
                            { sha: 'mno', author: 'author6', date: new Date('2021-02-15'), subject: 'comment', repo: 'repo' },
                        ],
    ...
    it('should return an array of records with repoPath and commits by month', () => {
        const reposByMonth = {
            ...
            '03-2021': [
                {
                    repoPath: 'user/repo1',
                    commits: [{ sha: 'xxx', author: 'author3', date: new Date('2021-03-01'), subject: 'comment', repo: 'repo' }],
                    authors: ['author1', 'author3'],
                },
                {
                    repoPath: 'user/repo2',
                    commits: [
                        { sha: 'yyy', author: 'author4', date: new Date('2021-03-01'), subject: 'comment', repo: 'repo' },
                        { sha: 'zzz', author: 'author6', date: new Date('2021-03-15'), subject: 'comment', repo: 'repo' },
                    ],
                    authors: ['author4', 'author6'],
                },
            ],
...
//# sourceMappingURL=repos-with-commits-by-month.spec.js.map
...
const cloc_monthly_diff_repos_1 = require("./cloc-monthly-diff-repos");
describe('flattenClocDiffStatsDict', () => {
    it('should flatten a dictionary of ClocDiffStats objects into a list of flattened objects', () => {
        ...
        const flattened = (0, cloc_monthly_diff_repos_1.flattenMonthlyClocDiffStatsDict)(repoStats);
...
//# sourceMappingURL=cloc-monthly-diff-repos.spec.js.map
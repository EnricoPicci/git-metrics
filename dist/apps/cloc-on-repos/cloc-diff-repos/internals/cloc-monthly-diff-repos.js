...
const repos_by_month_functions_1 = require("./repos-by-month.functions");
...
function calculateMonthlyClocDiffsOnRepos(folderPath, outdir, languages, fromDate = new Date(0), toDate = new Date(Date.now()), concurrency = config_1.CONFIG.CONCURRENCY) {
    ...
    return (0, repos_by_month_functions_1.reposCompactWithCommitsByMonthsInFolderObs)(folderPath, fromDate, toDate).pipe((0, rxjs_1.toArray)(), (0, rxjs_1.concatMap)((repos) => {
        ...
        const repoMonthlyCommitPairs = (0, commit_monthly_pair_functions_1.commitsMonthlyPairsForRepos)(reposCommitsDict);
        return (0, rxjs_1.from)(repoMonthlyCommitPairs);
    }), (0, rxjs_1.mergeMap)((repoMonthlyClocDiffs) => {
        return (0, commit_cloc_diff_function_1.calculateMonthlyClocGitDiffs)(repoMonthlyClocDiffs, languages);

...
const cloc_turnover_functions_1 = require("./cloc-turnover.functions");
describe('calculateClocDiffsOnRepos', () => {
    ...
    the commits will be calculated just for this folder`, (done) => {
        ...
        const concurrency = 1;
        (0, cloc_turnover_functions_1.calculateClocDiffsOnRepos)(folderPath, outDir, languages, fromDate, toDate, concurrency).subscribe({

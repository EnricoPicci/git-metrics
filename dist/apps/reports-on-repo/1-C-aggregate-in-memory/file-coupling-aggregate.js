...
function couplingDict(commits, after = new Date(0)) {
    const couplingDict = {};
    return commits.pipe((0, operators_1.reduce)((commitAcc, commit) => {
        ...
        commit.files.forEach((fileInCommit) => {
            ...
            fileInDict.linesAdded = (fileInCommit.linesAdded || 0) + (fileInDict.linesAdded || 0);
            fileInDict.linesDeleted = (fileInCommit.linesDeleted || 0) + (fileInDict.linesDeleted || 0);
...
function filterFilesWithMinNumOfCommits(depthInFilesCoupling) {
    return (0, rxjs_1.pipe)((0, operators_1.map)(({ listOfCouplings, numberOfCommitsForAllFiles, }) => {
        ...
        const filteredListSorted = filteredList.sort((a, b) => (b.howManyTimes_vs_totCommits || 0) - (a.howManyTimes_vs_totCommits || 0));

...
function mongoProjectInfo(params) {
    return mongoProjectCommitsInfo(params).pipe((0, rxjs_1.map)((commits) => ({ commits })), (0, rxjs_1.concatMap)((prjInfo) => (0, cloc_1.clocSummaryCsvRaw$)(params.repoFolderPath).pipe((0, rxjs_1.map)((clocSummaryInfo) => (Object.assign({ clocSummaryInfo }, prjInfo))))), (0, rxjs_1.tap)({

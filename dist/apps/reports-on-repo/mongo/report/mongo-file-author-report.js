...
function mongoFileAuthorReport(params, projectInfo, csvFilePath) {
    return _mongoFileAuthorReport(params, csvFilePath).pipe((0, operators_1.tap)((report) => {
        (0, add_project_info_1.addProjectInfo)(report, projectInfo, csvFilePath);
    }), (0, operators_1.map)((report) => report), (0, operators_1.map)((report) => (0, mongo_report_1.cleanParamsForReport)(report)), (0, operators_1.map)((report) => (0, file_authors_report_1.addConsiderationsForFileAuthorsReport)(report)));
}

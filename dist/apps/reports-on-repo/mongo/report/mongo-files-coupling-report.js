...
function mongoFilesCouplingReport(params, projectInfo, csvFilePath) {
    ...
    }), (0, operators_1.map)((report) => report), (0, operators_1.map)((report) => (0, mongo_report_1.cleanParamsForReport)(report)), (0, operators_1.map)((report) => (0, file_coupling_report_1.addConsiderationsForFilesCouplingReport)(report)));
}

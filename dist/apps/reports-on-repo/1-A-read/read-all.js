...
function readStreamsDistinctProcesses(commitOptions, readClocOptions) {
    ...
    return _streamsDistinctProcesses(commitOptions, readClocOptions, outGitFile, outClocSummaryFile);
}
exports.readStreamsDistinctProcesses = readStreamsDistinctProcesses;
function _streamsDistinctProcesses(commitOptions, readClocOptions, outGitFile, outClocSummaryFile) {

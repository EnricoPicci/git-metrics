...
class BranchesReport extends report_1.Report {
    //
    constructor(_params) {
        super(_params, exports.BRANCHES_REPORT_NAME, 'Report on the evolution of branches over time');
...
function mapDaylySummariesToCsv(allCommitDaylySummaries) {
    ...
    return (0, csv_tools_1.toCsv)(allCommitDaylySummariesCsvRecords);
}
function weeklySummariesToCsv(allCommitDaylySummaries) {
    ...
    return (0, csv_tools_1.toCsv)(allCommitWeeklySummariesCsvRecords);
}

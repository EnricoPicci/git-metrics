...
class AuthorChurnReport extends report_1.Report {
    constructor(_params) {
        super(_params, exports.AUTHOR_CHURN_REPORT_NAME, `Author churn report`);
...
function authorChurnReportCore(authorChurns, params, csvFilePath = '') {
    ...
    return (0, rxjs_1.forkJoin)(concurrentStreams).pipe((0, operators_1.tap)({
        next: (result) => console.log(`====>>>> AUTHOR CHURN REPORT GENERATED -- data saved in ${result[0]}`),
    }), (0, operators_1.map)((result) => result[0]));
}

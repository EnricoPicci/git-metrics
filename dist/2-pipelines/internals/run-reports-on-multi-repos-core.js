...
function runAllReportsOnMultiRepos(reports, repoFolderPaths, filter, after, before, outDir, outFilePrefix, clocDefsPath, depthInFilesCoupling, parallelReadOfCommits, noRenames) {
    ...
    const allReports = repoFolderPaths.map((repoFolderPath) => {
        ...
        const { _commitStream, _filesStream, _clocSummaryStream } = (0, run_reports_on_repo_core_1._streams)(commitLogPath, clocLogPath, clocSummaryPath, parallelReadOfCommits, after, before);
        // run the reports

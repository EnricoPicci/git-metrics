...
const repos_by_month_functions_2 = require("./repos-by-month.functions");
...
describe('groupRepoCommitsByMonth', () => {
    it('should group commits by month and year for multiple repos', () => {
        ...
        (0, chai_1.expect)((0, repos_by_month_functions_1.newReposWithCommitsByMonth)(repos)).deep.equal(expected);
    });
    it('should throw an exception when there is an empty array', () => {
        const repos = [];
        (0, chai_1.expect)(() => (0, repos_by_month_functions_1.newReposWithCommitsByMonth)(repos)).to.throw();
    });
});
// #copilot - good part of the boilerplate of these tests has been generated by copilot
describe('fillMissingMonths', () => {
    it('should fill in missing months between first and last months', () => {
        ...
        (0, repos_by_month_functions_2.fillMissingMonths)(reposByMonth, '2021-01', '2021-03', []);
    ...
    it('should not fill in months before first month or after last month', () => {
        ...
        (0, repos_by_month_functions_2.fillMissingMonths)(reposByMonth, '2021-04', '2021-06', []);
        (0, chai_1.expect)(reposByMonth).deep.equal(expected);
    });
    it('should not modify object if all months are present', () => {
        ...
        (0, repos_by_month_functions_2.fillMissingMonths)(reposByMonth, '2021-02', '2021-04', []);
        (0, chai_1.expect)(reposByMonth).deep.equal(expected);
    });
    it('should fill the missing months even when starting year and last year are different', () => {
        ...
        (0, repos_by_month_functions_2.fillMissingMonths)(reposByMonth, '2021-11', '2022-02', []);
        (0, chai_1.expect)(reposByMonth).deep.equal(expected);
    });
});
...
describe('repoCommitsByMonthRecords', () => {
    it('should return an array of records with repoPath and commits by month', () => {
        ...
        const records = (0, repos_by_month_functions_1.repoCommitsByMonthRecords)(reposByMonth);
...
//# sourceMappingURL=repos-by-month.functions.spec.js.map
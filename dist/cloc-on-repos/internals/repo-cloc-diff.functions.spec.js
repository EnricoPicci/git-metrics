...
describe('commitDiffPairs', () => {
    it('should return an object with pairs of most recent and least recent commits for each month', () => {
        ...
        const pairs = (0, repo_cloc_diff_functions_1.commitDiffPairs)(commitsByMonth);
...
describe('reposCommitsPairsDiff', () => {
    ...
    for each month`, () => {
        ...
        const expectedPairs_repo_1 = {
            '2021-03': [{ sha: 'def_1', date: new Date('2021-03-01'), author: 'author1' }, { sha: 'abc_1', date: new Date('2021-02-15'), author: 'author3' }],
            '2021-02': [{ sha: 'abc_1', date: new Date('2021-02-15'), author: 'author3' }, { sha: '456_1', date: new Date('2021-01-15'), author: 'author2' }],
            '2021-01': [{ sha: '456_1', date: new Date('2021-01-15'), author: 'author2' }, { sha: '123_1', date: new Date('2021-01-01'), author: 'author1' }],
        };
        const expectedPairs_repo_2 = {
            '2021-03': [{ sha: 'def_2', date: new Date('2021-03-01'), author: 'author1' }, { sha: 'abc_2', date: new Date('2021-02-15'), author: 'author3' }],
            '2021-02': [{ sha: 'abc_2', date: new Date('2021-02-15'), author: 'author3' }, { sha: '456_2', date: new Date('2021-01-15'), author: 'author2' }],
            '2021-01': [{ sha: '456_2', date: new Date('2021-01-15'), author: 'author2' }, { sha: '123_2', date: new Date('2021-01-01'), author: 'author1' }],
        };
        ...
        const repoDictPairs = (0, repo_cloc_diff_functions_1.reposCommitsPairsDiff)(repoDictWithCommits);
        (0, chai_1.expect)(repoDictPairs).deep.equal(expectedRepoDictPairs);
    });
});
//# sourceMappingURL=repo-cloc-diff.functions.spec.js.map
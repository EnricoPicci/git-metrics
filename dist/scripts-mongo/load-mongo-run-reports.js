...
function launchLoadMongoRunReports() {
    ...
    (0, load_mongo_run_reports_core_1.loadMongRunReports)(_options.connStr, _repoFolderPath, _options.filter, _options.after, _options.outDir, _options.outFile, _options.outClocFile, _dbName, _options.collName, _buffer, _options.clocDefsFile, _options.logProgress, _mongoConcurrency).subscribe({
        next: (reports) => {

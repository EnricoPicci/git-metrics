...
const commit_cloc_1 = require("./commit-cloc");
...
describe(`commitWithFileNumstatsEnrichedWithCloc$`, () => {
    ...
    with cloc data like lines of code, comment and blanks`, (done) => {
        ...
        const clocDict$ = (0, cloc_dictionary_1.clocFileDictFromClocStream$)(cloc$, process.cwd());
        (0, commit_cloc_1.commitWithFileNumstatsEnrichedWithCloc$)(commits$, clocDict$)
            .pipe((0, rxjs_1.tap)({
            next: (commitRec) => {
...
//# sourceMappingURL=commit-cloc.spec.js.map